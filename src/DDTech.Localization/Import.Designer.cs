...
namespace DDTech.Localization {
    ...
    public class Import {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Uploaded files contain all records for the upload types.
        /// </summary>
        public static string ImportMode_Replace_Description {
            get {
                return ResourceManager.GetString("ImportMode_Replace_Description", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to This mode is destructive and will delete records that are not in the uploaded files. The exceptions to this are Supply and Demand generated by Material Requirements Planning..
        /// </summary>
        public static string PurgeToolTip {
            get {
                return ResourceManager.GetString("PurgeToolTip", resourceCulture);
            }
        }
